...
class Sector(db.Model):
    ...
    males_2013 = db.Column(db.Float(10))
    females_2013 = db.Column(db.Float(10))
    total_2013 = db.Column(db.Float(10))
    males_2014 = db.Column(db.Float(10))
    females_2014 = db.Column(db.Float(10))
    total_2014 = db.Column(db.Float(10))
    males_2015 = db.Column(db.Float(10))
    females_2015 = db.Column(db.Float(10))
    total_2015 = db.Column(db.Float(10))
    males_2016 = db.Column(db.Float(10))
    females_2016 = db.Column(db.Float(10))
    total_2016 = db.Column(db.Float(10))
    males_2017 = db.Column(db.Float(10))
    females_2017 = db.Column(db.Float(10))
    total_2017 = db.Column(db.Float(10))
    males_2021 = db.Column(db.Float(10))
    females_2021 = db.Column(db.Float(10))
    total_2021 = db.Column(db.Float(10))
